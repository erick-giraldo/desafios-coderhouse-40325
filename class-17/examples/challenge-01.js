...
await init()
/*
await StudentModel.insertMany([{"first_name":"Justino","last_name":"Fidgin","email":"jfidgin0@boston.com","gender":"Male","grade":6,"g  roup":"1B"},
...
const result = await StudentModel.aggregate([
  ...
  {
    $group: {
      _id: '$group', avg: { $avg: '$grade' }
    }
  }*/
  {
    $group: {
      _id: 'one', avg: { $avg: '$grade' }
    }
  }
])
